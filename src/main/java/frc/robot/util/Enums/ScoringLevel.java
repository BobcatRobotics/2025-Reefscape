...
public enum ScoringLevel {
  ...
  CORAL_L4(SuperstructureState.POST_CORAL_SCORE_L4, SuperstructureState.POST_CORAL_SCORE_L4),
  ALGAE_L2(SuperstructureState.ALGAE_PREP_L2, SuperstructureState.ALGAE_LIFT_L2),
  ALGAE_L3(SuperstructureState.ALGAE_PREP_L3, SuperstructureState.ALGAE_LIFT_L3),
  NET(SuperstructureState.NET_PREP, SuperstructureState.RIGHT_SIDE_UP_IDLE);
