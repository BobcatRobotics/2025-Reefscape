...
public enum SuperstructureState {
  ...
  BACKWARDS_CORAL_SCORE_L4(ElevatorState.CORAL_L4, ArmState.BACKWARDS_CORAL_SCORE_L4),
  BACKWARDS_POST_CORAL_SCORE_L4(
      ElevatorState.POST_CORAL_L4, ArmState.BACKWARDS_POST_CORAL_SCORE_L4),
