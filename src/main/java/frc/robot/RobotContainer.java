...
public class RobotContainer {
    ...
    private final Alert buttonBoardUnpluggedAlert = new Alert("Button board unplugged!", AlertType.kWarning);
    private final Alert joystickUnpluggedAlert = new Alert("Operator Joystick unplugged!", AlertType.kWarning);
    private final Alert leftRuffyUnpluggedAlert = new Alert("Left ruffy unplugged!", AlertType.kWarning);
    private final Alert rightRuffyUnpluggedAlert = new Alert("Right Ruffy unplugged!", AlertType.kWarning);
    ...
    public RobotContainer() {
        switch (Constants.currentMode) {
            case REAL:
                ...
                limelightfl = new Vision(drive, new VisionIOLimelight(Constants.LimelightFLConstants.constants));
                limelightfr = new Vision(drive, new VisionIOLimelight(Constants.LimelightFRConstants.constants));
                limelightbl = new Vision(drive, new VisionIOLimelight(Constants.LimelightBLConstants.constants));
                limelightbr = new Vision(drive, new VisionIOLimelight(Constants.LimelightBRConstants.constants));
                ...
                endEffector = new EndEffector(new EndEffectorIOTalonFX(END_EFFECTOR_TALON_ID, END_EFFECTOR_LASER_ID));
                // endEffector = new EndEffector(new EndEffectorIO() {});
                intake = new CoralIntake(
            ...
            case SIM:
                ...
                superstructure = new Superstructure(new Arm(new ArmIOSim()), new Elevator(new ElevatorIOSim()));
    ...
    private void registerCommands() {
        ...
        // NamedCommands.registerCommand("IntakeDrop", new RunCommand(() ->
        // intake.deploy()));
        ...
        NamedCommands.registerCommand(
                ...
                new ConditionalCommand(
                        superstructure
                                ...
                                .andThen(
                                        superstructure
                                                .setState(SuperstructureState.POST_CORAL_SCORE_L4,
                                                        endEffector::hasPiece)
                                                .deadlineFor(endEffector.coralOut(() -> ScoringLevel.CORAL_L4)))
                                .withTimeout(0.3),
        ...
        NamedCommands.registerCommand(
                "PlaceL4NoRetract",
                superstructure.setState(SuperstructureState.CORAL_SCORE_L4, endEffector::hasPiece).andThen(
                        superstructure
