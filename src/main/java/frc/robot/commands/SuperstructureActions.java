...
public class SuperstructureActions {
     ...
     * <p>
     * This command assumes that the peice is already there,
     * it will NOT check to see if a peice is indexed
     * <p>
     * After it picks up the peice, the arm will flip around to the coral idle spot
     * 
     * END STATE: RIGHT_SIDE_UP_IDLE
     */
        ...
        return Commands.run(
                ...
                endEffector).andThen(
                        ...
                        endEffector.intakeCommand()
                                ...
                                .alongWith(superstructure.setState(SuperstructureState.CORAL_HANDOFF)
                                        // untill the end effector has the peice or 5 seconds pass
                                        .until(() -> endEffector.hasPiece()).withTimeout(5)))
     ...
     */
    public static Command prepScore(ScoringLevel level, Superstructure superstructure,
    ...
    public static Command score(
        ...
        return result.andThen(
                ...
                .withInterruptBehavior(InterruptionBehavior.kCancelSelf); // TODO should this be cancel self?
    }
