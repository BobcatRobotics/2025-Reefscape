...
public class DriveCommands {
    ...
    public static Command singleTagAlign(
        ...
        ProfiledPIDController horizontalController = new ProfiledPIDController(
    ...
    public static Command driveToReef(
        ...
        return Commands.run(
                () -> {
                    ...
                    double omegaOutput = angleController.calculate(drive.getPose().getRotation().getRadians(), nearestFace.getRotation().getRadians());
                    ...
                    drive.runVelocity(
                            ChassisSpeeds.fromFieldRelativeSpeeds(
                                    speeds,
                                    isFlipped
                                            ? drive.getRotation().plus(new Rotation2d(Math.PI)).plus(new Rotation2d(omegaOutput))
                                            : drive.getRotation().plus(new Rotation2d(omegaOutput))));
                },
                drive);
    }
}
